    ...
    <div className="App">
      ...
      <main className='flex flex-col items-center w-auto min-h-screen bg-green-200 bg-opacity-50 mx-35 my-10 rounded-2xl p-8 gap-5'>
        ...
        <div className='flex flex-col gap-2 items-center'>
          ...
          <button onClick={()=>{form.url ? savePassword : alert(`Can't save empty fields!`)}} className="flex gap-1 items-center border border-b-emerald-900 px-5 py-2 bg-green-500 rounded-full w-fit text-black hover:ring-2 hover:ring-green-400 active:bg-green-600 transition-all">
            <lord-icon
